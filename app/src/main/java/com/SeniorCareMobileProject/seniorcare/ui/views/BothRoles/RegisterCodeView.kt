...
@Composable
fun RegisterCodeView(navController: NavController, sharedViewModel: SharedViewModel) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun RegisterCodeViewPreview() {
    SeniorCareTheme() {
        val navController = rememberNavController()
        val sharedViewModel = SharedViewModel()
        RegisterCodeView(navController, sharedViewModel)
    }
}
